...
export class News extends Component {
  ...
  async componentDidMount() {
    let url =
      `https://newsapi.org/v2/top-headlines?country=us&apiKey=61b2e6781f0447d98bd5744bfbc9ad3c&page=1&pageSize=${this.props.pageSize}`;
  ...
  handlePrevClick = async ()=>{
    let url =
      `https://newsapi.org/v2/top-headlines?country=us&apiKey=61b2e6781f0447d98bd5744bfbc9ad3c&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
